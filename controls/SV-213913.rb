...
If procedures do not indicate access restrictions to the Certificate backup, this is a finding.'
  desc 'fix', "Document and implement procedures to safely back up and store the Certificate used for encryption in a secure location that is not on the SQL Server. Include in the procedures to establish evidence of backup and storage as well as careful, restricted access and restoration of the Certificate.
...
As this requires a password, ensure it is not exposed to unauthorized persons or stored as plain text."
  ...
  tag check_id: 'C-15131r952219_chk'
  tag severity: 'medium'
  tag gid: 'V-213913'
  tag rid: 'SV-213913r961128_rule'
  tag stig_id: 'SQL6-D0-001800'
  tag gtitle: 'SRG-APP-000231-DB-000154'
  tag fix_id: 'F-15129r951656_fix'
  tag 'documentable'
